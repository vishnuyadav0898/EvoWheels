...
import{Data} from "../ComponentData/OwnershipData"
...
function OwnerShip() {
  ...
  return (
    <div id="ownership" className="p-4 2xl:px-16">
      {selectedTechnology ? (
        ...
        <div className="flex flex-col w-full gap-4 mt-5 p-3">
          <h1 className="text-4xl 2xl:text-5xl xl:text-4xl lg:text-3xl font-medium">Ownership & More</h1>
          <p className="text-base md:text-md lg:text-lg  xl:text-2xl 2xl:text-3xl">
            Explore our Hyperservice, Battery Warranty, E store, Hyper Charger, and Referls!
          </p>
